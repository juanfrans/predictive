...
local_path = "/Users/juansaldarriaga/Google_Drive/02_Freelancing/02_Projects/1505_Taxi_Predictions/05_Processing/01_Base_Data/160201_Test_Model/"

with open(local_path + 'dataModel_02.pkl', 'rb') as f:
	dataModel = pickle.load(f)

with open(local_path + 'scaler_02.pkl', 'rb') as f:
